        ...
        <div className="lg:col-span-2 bg-slate-100 rounded-[2.5rem] border border-slate-200 relative overflow-hidden group">
          ...
          <div className="absolute bottom-6 left-6 right-6 flex flex-col gap-3">
            <div className="flex gap-4">
              <button className="flex-1 py-4 bg-blue-500 text-white font-black text-sm rounded-2xl shadow-xl shadow-blue-500/30 hover:bg-blue-600 transition-all flex items-center justify-center gap-2 active:scale-95">
                <Navigation size={18} />
                EN ROUTE
              </button>
              <button className="flex-1 py-4 bg-amber-500 text-white font-black text-sm rounded-2xl shadow-xl shadow-amber-500/30 hover:bg-amber-600 transition-all flex items-center justify-center gap-2 active:scale-95">
                <MapPin size={18} />
                ON SITE
              </button>
            </div>
            <div className="flex gap-4">
              <button className="flex-[2] py-4 bg-emerald-500 text-white font-black text-lg rounded-2xl shadow-xl shadow-emerald-500/30 hover:bg-emerald-600 transition-all flex items-center justify-center gap-3 active:scale-95">
                <CheckCircle size={24} />
                MARK AS RESOLVED
              </button>
              <button className="flex-1 bg-white border border-slate-200 rounded-2xl flex items-center justify-center text-rose-500 shadow-xl hover:bg-rose-50 transition-colors">
